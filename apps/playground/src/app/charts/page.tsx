      ...
      <Container>
        <Stack gap={10}>
          ...
          <Grid cols={1} responsive={{ base: 1, md: 3 }} gap={4}>
            <Card>
              <Stat label="MRR" value="$24,820" delta={{ value: '+12%', direction: 'up' }} description="vs last month" />
            </Card>
            <Card>
              <Stat label="Active users" value="3,142" delta={{ value: '-3%', direction: 'down' }} description="vs last week" />
            </Card>
            <Card>
          ...
          <Grid cols={1} responsive={{ base: 1, lg: 2 }} gap={4}>
            <Card padding="md">
              <CardHeader className="mb-2"><CardTitle>Revenue vs Costs</CardTitle></CardHeader>
              <BarChart data={barData} xKey="month" yKeys={['revenue', 'costs']} />
            </Card>
            <Card padding="md">
              <CardHeader className="mb-2"><CardTitle>Users (line)</CardTitle></CardHeader>
              <LineChart data={areaData} xKey="month" yKeys={['users']} legend={false} />
            </Card>
            <Card padding="md">
              <CardHeader className="mb-2"><CardTitle>Users (area)</CardTitle></CardHeader>
              <AreaChart data={areaData} xKey="month" yKeys={['users']} legend={false} />
            </Card>
            <Card padding="md">
              <CardHeader className="mb-2"><CardTitle>Engines</CardTitle></CardHeader>
              <DonutChart data={donutData} />
            </Card>
          </Grid>
          <Card>
            <CardHeader className="mb-2"><CardTitle>Sparkline</CardTitle></CardHeader>
