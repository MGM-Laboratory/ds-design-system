...
const meta = { title: 'Components/Link', component: Link, tags: ['autodocs'] } satisfies Meta<typeof Link>;
export default meta;
...
export const Tones: Story = {
  render: () => (
    <div className="flex flex-col gap-2">
      ...
      <Link href="https://npmjs.com/org/labmgm" external>External link (new tab)</Link>
    </div>
  ),
};
