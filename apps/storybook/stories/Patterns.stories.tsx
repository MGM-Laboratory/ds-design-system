...
import { PatternGrid, PatternCorner, PatternBanner, PatternDado, PatternPyramid, PatternStrip } from '@labmgm/patterns';
...
export const Banner: Story = { render: () => <PatternBanner rows={2} cols={6} seed="story-banner" /> };
export const Strip: Story = { render: () => <PatternStrip tiles={20} tileSize={32} seed="story-strip" /> };
export const Dado: Story = { render: () => <PatternDado tiles={80} /> };
export const Pyramid: Story = { render: () => <PatternPyramid height={6} tileSize={48} seed="story-pyr" /> };
