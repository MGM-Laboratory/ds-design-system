    ...
    return (
      ...
      >
        <RadixSlider.Track className="relative h-1.5 grow overflow-hidden rounded-full bg-line">
          <RadixSlider.Range className="absolute h-full bg-ink" />
        </RadixSlider.Track>
        <RadixSlider.Thumb className="block h-5 w-5 rounded-full border-2 border-ink bg-bg shadow-1 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2" />
      </RadixSlider.Root>
    );
  },
);
